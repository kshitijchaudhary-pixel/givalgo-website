...
USECASES={
 ...
 'for/platforms': dict(title='For Grant Management and Giving Platforms | Givalgo',
   desc='Nonprofit verification, organization data, and on-demand diligence briefs built into your product with one API integration.',
   page=uc_page("FOR GRANT MANAGEMENT &amp; GIVING PLATFORMS","Nonprofit verification and data, built into your product.",
     "One API integration for eligibility checks, organization profiles, and on-demand diligence briefs. Refreshed nightly from IRS and sanctions sources, provisioned in less than 24 hours.",
